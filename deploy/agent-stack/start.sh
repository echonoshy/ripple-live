...
MEETING_MAX_CHUNK_BYTES="${RIPPLE_MEETING_MAX_CHUNK_BYTES:-2097152}"
FFMPEG_BIN="${RIPPLE_FFMPEG_BIN:-ffmpeg}"
...
start_process gateway env \
  ...
  RIPPLE_MEETING_MAX_CHUNK_BYTES="$MEETING_MAX_CHUNK_BYTES" \
  RIPPLE_FFMPEG_BIN="$FFMPEG_BIN" \
