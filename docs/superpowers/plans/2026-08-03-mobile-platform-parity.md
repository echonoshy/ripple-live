...
**Files:**
- Create: `apps/mobile/tests/mobile-package.test.mjs`
...
- [ ] Run `cd apps/mobile && node --test tests/mobile-package.test.mjs`; confirm it fails because the source icon and the two privacy keys are absent.
- [ ] Add `"test:mobile": "node --test tests/mobile-package.test.mjs"` to `apps/mobile/package.json`.

### Task 2: Implement canonical icon generation

**Files:**
- Create: `apps/mobile/src-tauri/icons/ripple-live-source.png`
- Create: `apps/mobile/scripts/generate-mobile-icons.sh`
- Modify: `apps/mobile/src-tauri/icons/*`
- Modify: `apps/mobile/src-tauri/gen/android/app/src/main/res/mipmap-*/ic_launcher*.png`
- Modify: `apps/mobile/src-tauri/gen/apple/Assets.xcassets/AppIcon.appiconset/*.png`
...
- [ ] Run `cd apps/mobile && bash scripts/generate-mobile-icons.sh`.
...
**Files:**
- Modify: `apps/mobile/src-tauri/gen/apple/ripple-live_iOS/Info.plist`
...
- [ ] Run `cd apps/mobile && npm run test:mobile`; expect zero failures.
...
- [ ] Run `cd apps/mobile && npm ci`, then create a development-signed iOS archive/export through Tauri/Xcode using bundle id `cn.minicpm.live`.
